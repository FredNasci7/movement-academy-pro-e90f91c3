...
import modalidadeGinastica from "@/assets/modalidade-ginastica.jpg";
import modalidadeGinasticaFormacao from "@/assets/modalidade-ginastica-formacao.jpg";
import modalidadeGinasticaRepresentacao from "@/assets/modalidade-ginastica-representacao.jpg";
import modalidadeAulasGrupo from "@/assets/modalidade-aulas-grupo.jpg";
import modalidadeTreino from "@/assets/modalidade-treino.jpg";
...
const services = [{
  ...
  features: ["Jogos e atividades lúdicas", "Desenvolvimento da coordenação", "Primeiros elementos básicos", "Socialização e trabalho em grupo", "Aulas adaptadas à idade"],
  image: modalidadeGinasticaFormacao,
  ...
  features: ["Trabalho em pares, trios ou grupos", "Coreografia e musicalidade", "Desenvolvimento de confiança e cooperação", "Expressão corporal e criatividade"],
  image: modalidadeGinasticaRepresentacao,
  ...
  features: ["🗓️ Sessões Personalizadas Individuais", "🏋️‍♂️ Avaliação inicial", "📝 Criação de metas mensais", "📋 Plano de Treino Semanal", "📈 Controlo Mensal e monitorização de resultados"],
  image: modalidadeTreino,
  color: "from-accent to-primary",
  buttonText: "Agendar",
